        ...
        <Dialog open={showModal} onOpenChange={closeModal}>
            <DialogContent className="w-full">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        <DialogTitle className="font-bold text-lg mb-2">{type === "edit" ? "Edit Project" : "Add New Project"}</DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="space-y-5 py-4">
                        ...
                        {/* Status */}
                        <div className={`grid ${type === "edit" ? 'grid-cols-3' : 'grid-cols-1'} gap-4`}>
                            {type === "edit" && (
                                <>
                                    <div className="space-y-2">
